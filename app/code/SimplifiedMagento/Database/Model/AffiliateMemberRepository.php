...
class AffiliateMemberRepository implements AffiliateMemberRepositoryInterface
{
     ...
     * @param \SimplifiedMagento\Database\Model\AffiliateMemberFactory $affiliateMemberFactory
     */
    public function __construct(CollectionFactory $collectionFactory, AffiliateMemberFactory $affiliateMemberFactory, AffiliateMember $affiliateMember, AffiliateMemberSearchResultInterfaceFactory $resultInterfaceFactory, CollectionProcessor $collectionProcessor)
    {
    ...
    /**
     * @return \Magento\Framework\DataObject[]|\SimplifiedMagento\Database\Api\Data\AffiliateMemberInterface[]
     */
    ...
    /**
     * @param int $id
     * @return \SimplifiedMagento\Database\Api\Data\AffiliateMemberInterface[]|AffiliateMember
     */
